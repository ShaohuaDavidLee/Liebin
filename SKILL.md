...
样张交出去之后，问三个问题，一个都不能省。**确认页用选项，不要丢两个空文本框。** 每问一组可多选的句子，外加「其他」让人填原话。点中的句子和「其他」里的字，逐字进 DESIGN.md，不要润色。

1. **选哪个？** ——只能答「贴着做 / 取其神 / 反着来」，或者三个都不要。
2. **另外两个，哪里不要？** ——这一问才是整件事的核心。用户说得出"这个圆角太软了""这个字太挤了"，说不出"我要什么"。选项对不上就写在「其他」，**点名是哪一版。**
3. **你的用户在什么状态下打开这个产品？** ——非视觉问题，但它会推翻大部分"好看"的选择。手机单手、旁边有人、赶时间、情绪紧——这些指向完全不同的设计。场景比选项具体，写在「其他」。如果三个变体全都答不上这一问，就该重做，而不是硬选一个。
